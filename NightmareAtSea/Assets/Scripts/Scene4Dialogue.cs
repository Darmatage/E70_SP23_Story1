...
public void next(){
        ...
        if (primeInt == 1){
               ...
               ArtChar1a.SetActive(true);
                ...
                Char1speech.text = "";
                Char2name.text = "Turtle";
                Char2speech.text = "Most people call me the “Old Wise Turtle” since I am over one thousand years old!";
        }
       else if (primeInt == 5){
                Char1name.text = "YOU";
                Char1speech.text = "That is old. Do you have any advice for me?";
                Char2name.text = "";
                Char2speech.text = "";
                //gameHandler.AddPlayerStat(1);
        }
